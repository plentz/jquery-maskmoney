(function($) {
	...
	test("with prefix", function() {
		...
		strictEqual(unmasked, 123456.78, "unmask method return the correct number when the field value has prefix");
	});
	...
	test("with suffix", function() {
		...
		input.val("123.456,78 €");
		unmasked = input.maskMoney("unmasked")[0];
		strictEqual(unmasked, 123456.78, "unmask method return the correct number when the field value has suffix");
	});
	...
	test("with prefix and suffix", function() {
		...
		input.val("+ 123.456,78 €");
		unmasked = input.maskMoney("unmasked")[0];
		strictEqual(unmasked, 123456.78, "unmask method return the correct number when the field value has prefix and suffix");
	});
